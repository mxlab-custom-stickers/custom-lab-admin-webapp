import { templateEditorReducer } from '@/contexts/template-editor-reducer.ts';
import type {
  PreviewMode,
  TemplateEditorAction,
  TemplateEditorState,
} from '@/contexts/template-editor-types.ts';
...
import * as firestore from '@clab/firebase';
import type { Template, TemplateLayer } from '@clab/types';
import { stripFabricObjectsFromTemplate } from '@clab/utils';
